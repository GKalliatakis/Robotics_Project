...
def setup_task_environment(self):
    ...
    self.waypoints.append(Pose(Point(0.055, 0.119, 0.000), Quaternion(00.000, 0.000, 0.717, 0.697)))

    self.waypoints.append(Pose(Point(2.503, 0.315, 0.000), Quaternion(0.000, 0.000, 0.701, 0.713)))
    self.waypoints.append(Pose(Point(2.422, 2.463, 0.000), Quaternion(0.000, 0.000, 1.000, -0.019)))
    self.waypoints.append(Pose(Point(0.007, 2.509, 0.000), Quaternion(0.000, 0.000, -0.708, 0.707)))
    ...
    # set number of humans detected
    self.humans = 0

    # publisher to start the human detection
    self.humanDetect_pub = rospy.Publisher('/detector/state',String)

    # subsciber to get the detection outcome
    self.detectionOutcome_sub = rospy.Subscriber('/detector/outcome',String, self.detectionCallback)    
